...
.curso-main-container.introduccion
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-5 Estimado aprendiz, a través del siguiente video, podrá conocer los aspectos relevantes que abordará este componente:

    figure.col-xl-10.mx-auto.mb-5(data-aos="fade-left")
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/2L91WMqw96A" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
    p.mb-5 Para la elaboración de este componente, se abordaron varios autores conocidos que han escrito sobre ejecución de eventos deportivos, de quienes se han citado y referenciado conceptos y ejemplos con fines educativos, en el entendido de que el conocimiento es social y, por lo tanto, es para ser usado por quienes necesitan adquirirlo. Se espera que este documento sea útil para todos aquellos, aprendices y lectores en general, que estén interesados en acercarse a asuntos básicos de gestión de las organizaciones deportivas.

    h3.mb-5 Ejecución del evento
    ...
    .container-100.pb-5(
      ...
      img.mx-auto(src="@/assets/curso/temas/img-2.svg" style="max-width: 766px")


    p.mb-0 Para la ejecución del evento, se considera muy importante la coordinación de tareas, actividades y recursos, realizar el seguimiento y control correspondiente a través de los responsables asignados, cuando se ponen en marcha el evento.
