  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 3
      h1 Verificación de tareas asignadas 
    
    .d-flex.flex-wrap.align-items-center.mb-5
      img.col-lg-4.mx-auto.mb-4.mb-lg-auto(src="@/assets/curso/temas/tema3/img-1.png" style="max-width: 400px")
      .col-lg-8.ps-lg-4
        p Cuando se organiza un evento, se deben tener claras las actividades que desarrollará cada comité y, por supuesto, realizar la verificación del cumplimiento de estas tareas, teniendo en cuenta el nivel de importancia y los tiempos asignados para ellas. Los coordinadores o supervisores de cada uno de los comités son los encargados de realizar la verificación de las tareas asignadas.
    ...
    p.mb-5 Existen diferentes formas de realizar la verificación de las tareas asignadas. Se deben tener en cuenta los siguientes puntos: observación directa, listas de chequeo y <em>softwares</em> especializados.
    ...
    p.mb-5 Es importante, después de realizar la verificación, tener un instrumento de soporte, como una lista de chequeo, y elaborar un informe del mismo, para garantizar que el seguimiento a las tareas ha sido realizado. Los supervisores y coordinadores de los comités deben tener en cuenta los siguientes aspectos para realizar la verificación de tareas:
    ...
    .d-flex.flex-wrap
      ...
      img.col-lg-4.mx-auto.mb-4.mb-lg-auto(src="@/assets/curso/temas/tema3/img-5.png" style="max-width: 400px")
</template>
