  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 5
      h1 Seguimiento y control del evento
    .d-flex.flex-wrap
    ...
    p.mb-5 A continuación, se presenta un paralelo con respecto a reuniones estratégicas y operativas: 

    .container-decorativo-1.col-xl-10.mx-auto.mb-5
      .container-card-decorativo-1.col-12.col-lg
    ...
    p.mb-5 Para el control en general operativo del evento, es importante tener en cuenta estos aspectos:
    ...
    .d-flex.flex-wrap.mb-5
      ...
      img.col-lg-4.mx-auto.mb-4.mb-lg-auto(src="@/assets/curso/temas/tema5/img-2.png" style="max-width: 400px")

    .d-flex.flex-wrap.align-items-center.mb-5
      img.col-lg-4.mx-auto.mb-4.mb-lg-auto(src="@/assets/curso/temas/tema5/img-3.png" style="max-width: 400px")
      .col-lg-8.ps-lg-4
