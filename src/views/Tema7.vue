...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    h3 Ceremonias de premiación
    p.mb-5 es donde se realiza la premiación de los deportistas en cada disciplina o evento deportivo, esta ceremonia debe estar coordinada y desarrollada según el plan de acción del evento, teniendo en cuenta lo siguiente: 
    ...
    .d-flex.flex-wrap.mb-5
      ...
      img.col-lg-4.mx-auto.mb-4.mb-lg-auto(src="@/assets/curso/temas/tema7/img-2.png" style="max-width: 400px")

    p.mb-5 De acuerdo con lo anterior, a continuación, se relacionan los pasos para el cierre del evento:

    .d-flex.flex-wrap.align-items-center.mb-5
      img.col-lg-4.mx-auto.mb-4.mb-lg-auto(src="@/assets/curso/temas/tema7/img-3.png" style="max-width: 400px")
      .col-lg-8.ps-lg-4
        ul.lista-ul--separador
          li.d-flex
            i.fas.fa-angle-right(style="color: #FE502D; font-size: 20px")
